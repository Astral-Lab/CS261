...
export default function JunctionFlowHints() {
    return (
        <div className="w-full h-full lg:h-auto z-10 bg-white lg:bg-transparent p-8 lg:p-0 lg:px-0 opacity-0 lg:opacity-100 transition-opacity duration-300 group-[:has(:checked)]/hint:opacity-100 absolute inset-0 lg:static">
